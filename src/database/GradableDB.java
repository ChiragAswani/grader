...
public class GradableDB extends DBconn implements GradableDAO {
    ...
    public Gradable findOneGradableInCourse(String courseID,int gradableid) throws Exception {
        ...
        if (rs.next()){
            ...
            gradable.setCostomized(rs.getInt("costomized"));
            ...
            gradable.setCourseID(rs.getString("courseid"));
    ...
    public Gradable addGradableToOneCourse(Gradable g) throws Exception{
        ...
        g.setgID(gid);
        Connection conn=DBconn.getConnection();
        String sql="insert into distribution(courseid,gradableid,weighting_undergraduate,weighting_graduate,costomized) values(?,?,?,?,?)";
        PreparedStatement stmt= conn.prepareStatement(sql);
        stmt.setString(1,g.getCourseID());
        stmt.setInt(2,g.getgID());
        stmt.setBigDecimal(3,g.getWeight_ungrad());
        stmt.setBigDecimal(4,g.getWeight_grad());
        stmt.setInt(5,g.getCostomized());
        stmt.executeUpdate();
        return g;
    }
    ...
    public void removeGradableFromOneCourse(Gradable g) throws Exception{
        ...
        stmt.setString(2,g.getCourseID());
        stmt.executeUpdate();
